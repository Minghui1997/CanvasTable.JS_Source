        ...
        if(CT_ContainerDraw[i] != null) //如果当前draw不为空
        {
            ...
            if(draw_l === l) //如果当前draw层等于当前渲染层
            {
                ...
                if(draw_type === 1) //如果当前draw是矩形
                {
                    ...
                    CTBCanvas_Rect(x-_x,y-_y,w,h,c,f); //绘制矩形
                }
                if(draw_type === 2) //如果draw类型是线
                {
                    ...
                    CTBCanvas_Line(x1-_x,y1-_y,x2-_x,y2-_y,w,c); //绘制线
                }
                if(draw_type === 3) //如果draw类型是圆
                {
                    ...
                    CTBCanvas_Circle(x-_x,y-_y,r,c,f); //绘制圆
                }
                if(draw_type === 4) //如果draw类型是字符串
                {
                    ...
                    CTBCanvas_String(x-_x,y-_y,s,c,str); //绘制字符串
                }
                if(draw_type === 5) //如果draw类型是图像
                {
                    ...
                    CTBCanvas_Image(x-_x,y-_y,img); //绘制图像
                }
                if(draw_type === 6) //如果draw类型是图像部分
                {
                    ...
                    CTBCanvas_ImagePart(x-_x,y-_y,img,ix,iy,iw,ih); //绘制图像部分
                }
                if(draw_type === 7) //如果draw类型是曲线
                {
                    ...
                    CTBCanvas_Curve(x1-_x,y1-_y,x2-_x,y2-_y,x3-_x,y3-_y,w,c); //绘制曲线
                }
                if(draw_type === 8) //如果draw类型是三角形
                {
                    ...
                    CTBCanvas_Tri(x1-_x,y1-_y,x2,y2,x3,y3,c,f); //绘制三角形
                }
            }
        }
    }
