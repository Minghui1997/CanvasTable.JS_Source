...
var CT_dialogTitle; //对话框标题
var CT_dialogTextbox; //对话框文本框
var CT_dialogButton; //文本框按钮
//--------------------------------------------------------------------
// 对话框创建
//--------------------------------------------------------------------
function CT_DialogCreate(val,name,max,pass,numb)
{
    var font_s = parseInt(CT_ClientH * 0.5 * 0.1); //对话框字体大小
    if(CT_DialogShow === 0) //如果对话框没有显示
    {
        ...
        CT_dialogBack.style.backgroundColor = "#d0cfcbaf";
        ...
        CT_dialog.style.borderColor = "#ece9d8";
...
{
    var data_i = CT_Dialog_Index * 30; //文本框数据索引
    if(CT_ContainerUI[data_i] !== 0) //如果对话框对应文本框的窗口不为空
    {
        CT_ContainerUI[data_i+15] = CT_dialogTextbox.value; //将对话框输入的内容返回给文本框
    }
